...
import me.dio.simulator.databinding.MatchItenBinding;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MatchItenBinding binding = MatchItenBinding.inflate(layoutInflater, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private  final MatchItenBinding binding;

        public ViewHolder(MatchItenBinding binding) {
